...
public class NegocioProfessor {
    ...
    static public boolean VerificadorCPF (String strCpf )
   {
    ...
    public void buscar(FormCadastroProfessor form_professor)
    {
        Professor objProfessorSelecionado = null;

        String cpf = form_professor.jTextFieldBuscaCPF.getText();
        BdProfessorDAO objBdProfessor= new BdProfessorDAO();
        ...
        {
            form_professor.jTextNome.setText(objProfessorSelecionado.getNome());
            form_professor.jTextCpf.setText(objProfessorSelecionado.getCpf());
            form_professor.jTextCpf.setEditable(false);
            form_professor.jTextEmail.setText(objProfessorSelecionado.getEmail());
        }
        else
        {
